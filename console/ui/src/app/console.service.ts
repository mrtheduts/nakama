...
export interface ApiMetrics {
  ...
  // The username of the user's account.
  username?: string;
  // The score of the user's account.
  score?: number;
  // The time the user spent playing.
  time_playing?: number;
...
/** A user account associated to a metrics. */
export interface Metrics {
  // The user this metrics belongs to.
  user_id?: string;
  // The username for display purposes.
  username?: string;
}
...
export class ConsoleService {
  ...
  listAccounts(
    ...
    return this.httpClient.get<AccountList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }

  /** List (and optionally filter) metrics. */
  listMetrics(
    auth_token: string,
    filter?: string,
    tombstones?: boolean,
    ...
    return new Observable<MetricsList>((s) => {
      let accountsPromise = this.httpClient
        .get<AccountList>(this.config.host + urlPath, {
          params: params,
          headers: this.getTokenAuthHeaders(auth_token),
        })
        .toPromise();
      ...
      accountsPromise
        .then((accounts) => {
          const ROOT_USR = "00000000-0000-0000-0000-000000000000";
          const listStorageObjPath =
            "/v2/console/api/endpoints/ListStorageObjects";
          ...
          accounts.users?.forEach((u) => {
            ...
            let listStoragePromise = this.httpClient
              .post<CallApiEndpointResponse>(
                this.config.host + listStorageObjPath,
                {
            ...
            listStoragePromise.then((response) => {
              ...
              obj.objects.forEach((entry) => {
                let value = JSON.parse(entry.value);
                metric[entry.key] = value.value;

                if (entry.key === "time_playing") {
                  metric.last_active = entry["updateTime"];
                }
              });
            ...
            listStoragePromises.push(listStoragePromise);
          });

          Promise.all(listStoragePromises).then(() => {
            s.next(metricsList);
          });
        })
        .catch((reason) => s.next(null));
    });
  }
  ...
  getWalletLedger(
    ...
    return this.httpClient.get<WalletLedgerList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getAccount(auth_token: string, id: string): Observable<Account> {
    ...
    const urlPath = `/v2/console/account/${id}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<Account>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  exportAccount(auth_token: string, id: string): Observable<AccountExport> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<AccountExport>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getFriends(auth_token: string, id: string): Observable<ApiFriendList> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiFriendList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getGroups(auth_token: string, id: string): Observable<ApiUserGroupList> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiUserGroupList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listApiEndpoints(auth_token: string): Observable<ApiEndpointList> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiEndpointList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  callRpcEndpoint(
    auth_token: string,
    method: string,
    body: CallRpcEndpointRequest,
  ): Observable<CallApiEndpointResponse> {
    method = encodeURIComponent(String(method));
    const urlPath = `/v2/console/api/endpoints/rpc/${method}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.post<CallApiEndpointResponse>(
      this.config.host + urlPath,
      body,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  authenticate(body: AuthenticateRequest): Observable<ConsoleSession> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.post<ConsoleSession>(
      this.config.host + urlPath,
      body,
      { params: params },
    );
  ...
  authenticateLogout(
    auth_token: string,
    body: AuthenticateLogoutRequest,
  ): Observable<any> {
  ...
  listChannelMessages(
    ...
    user_id_two?: string,
    cursor?: string,
  ): Observable<ApiChannelMessageList> {
    ...
    return this.httpClient.get<ApiChannelMessageList>(
      this.config.host + urlPath,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  getConfig(auth_token: string): Observable<Config> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<Config>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listGroups(
    ...
    return this.httpClient.get<GroupList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getGroup(auth_token: string, id: string): Observable<ApiGroup> {
    ...
    const urlPath = `/v2/console/group/${id}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiGroup>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  exportGroup(auth_token: string, id: string): Observable<GroupExport> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<GroupExport>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getMembers(auth_token: string, id: string): Observable<ApiGroupUserList> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiGroupUserList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listLeaderboards(
    auth_token: string,
    cursor?: string,
  ): Observable<LeaderboardList> {
    const urlPath = `/v2/console/leaderboard`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    if (cursor) {
      params = params.set("cursor", cursor);
    }
    return this.httpClient.get<LeaderboardList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getLeaderboard(auth_token: string, id: string): Observable<Leaderboard> {
    ...
    const urlPath = `/v2/console/leaderboard/${id}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<Leaderboard>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listLeaderboardRecords(
    ...
    return this.httpClient.get<ApiLeaderboardRecordList>(
      this.config.host + urlPath,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  listMatches(
    ...
    return this.httpClient.get<MatchList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getMatchState(auth_token: string, id: string): Observable<MatchState> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<MatchState>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  deleteChannelMessages(
    ...
    before?: string,
    ids?: Array<string>,
  ): Observable<DeleteChannelMessagesResponse> {
    ...
    return this.httpClient.delete<DeleteChannelMessagesResponse>(
      this.config.host + urlPath,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  listPurchases(
    ...
    return this.httpClient.get<ApiPurchaseList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getRuntime(auth_token: string): Observable<RuntimeInfo> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<RuntimeInfo>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  getStatus(auth_token: string): Observable<StatusList> {
    ...
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<StatusList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listStorage(
    ...
    return this.httpClient.get<StorageList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  listStorageCollections(
    auth_token: string,
  ): Observable<StorageCollectionsList> {
    const urlPath = `/v2/console/storage/collections`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<StorageCollectionsList>(
      this.config.host + urlPath,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  getStorage(
    ...
    key: string,
    user_id: string,
  ): Observable<ApiStorageObject> {
    collection = encodeURIComponent(String(collection));
    key = encodeURIComponent(String(key));
    user_id = encodeURIComponent(String(user_id));
    const urlPath = `/v2/console/storage/${collection}/${key}/${user_id}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<ApiStorageObject>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }
  ...
  writeStorageObject(
    ...
    key: string,
    user_id: string,
    body: WriteStorageObjectRequest,
  ): Observable<ApiStorageObjectAck> {
    collection = encodeURIComponent(String(collection));
    key = encodeURIComponent(String(key));
    user_id = encodeURIComponent(String(user_id));
    const urlPath = `/v2/console/storage/${collection}/${key}/${user_id}`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.put<ApiStorageObjectAck>(
      this.config.host + urlPath,
      body,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  ...
  listSubscriptions(
    ...
    limit?: number,
    cursor?: string,
  ): Observable<ApiSubscriptionList> {
    ...
    return this.httpClient.get<ApiSubscriptionList>(
      this.config.host + urlPath,
      { params: params, headers: this.getTokenAuthHeaders(auth_token) },
    );
  }
  ...
  listUsers(auth_token: string): Observable<UserList> {
    const urlPath = `/v2/console/user`;
    let params = new HttpParams({ encoder: new CustomHttpParamEncoder() });
    return this.httpClient.get<UserList>(this.config.host + urlPath, {
      params: params,
      headers: this.getTokenAuthHeaders(auth_token),
    });
  }

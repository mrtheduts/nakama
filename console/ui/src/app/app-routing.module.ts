...
import {
  ...
  StorageSearchResolver,
} from "./storage/storage.component";
import {
  StorageObjectComponent,
  StorageObjectResolver,
} from "./storage-object/storage-object.component";
import {
...
import {
  WalletComponent,
  WalletLedgerResolver,
} from "./account/wallet/wallet.component";
import {
  FriendsComponent,
  FriendsResolver,
} from "./account/friends/friends.component";
import {
  GroupsComponent,
  GroupsResolver,
} from "./account/groups/groups.component";
import { GroupDetailsComponent } from "./group/details/groupDetailsComponent";
import {
  GroupMembersComponent,
  GroupMembersResolver,
} from "./group/members/groupMembers.component";
import {
  MatchesComponent,
  MatchesResolver,
  NodesResolver,
} from "./matches/matches.component";
import {
  GroupListComponent,
  GroupSearchResolver,
...
} from "./leaderboard/records/records.component";
import {
  ApiExplorerComponent,
  ApiExplorerEndpointsResolver,
} from "./apiexplorer/apiexplorer.component";
import {
  PurchasesComponent,
  PurchasesResolver,
} from "./account/purchases/purchases.component";
import {
  ChatListComponent,
  ChatSearchResolver,
} from "./channels/chatMessages.component";
import {
  SubscriptionsComponent,
  SubscriptionsResolver,
} from "./account/subscriptions/subscriptions.component";
import { MetricsComponent, MetricsResolver } from "./metrics/metrics.component";
...
const routes: Routes = [
  {
    ...
    children: [
      { path: "", redirectTo: "status", pathMatch: "full" },
      {
        ...
        resolve: [GraphInitNodesResolver],
      },
      ...
      },
      {
        ...
        resolve: [StorageCollectionResolver, StorageSearchResolver],
        pathMatch: "full",
      },
      {
        path: "storage/:collection/:key/:user_id",
        component: StorageObjectComponent,
        resolve: [StorageObjectResolver],
        pathMatch: "full",
      },
      {
        path: "leaderboards",
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "records",
            component: LeaderboardRecordsComponent,
            resolve: [LeaderboardRecordsResolver],
          },
        ],
      },
      {
        ...
        resolve: [MatchesResolver, NodesResolver],
      },
      {
        path: "groups",
        component: GroupListComponent,
        resolve: [GroupSearchResolver],
      },
      {
        path: "groups/:id",
      ...
      },
      {
        ...
        resolve: [ApiExplorerEndpointsResolver],
      },
      {
        path: "chat",
        component: ChatListComponent,
        resolve: [ChatSearchResolver],
      },
      {
        path: "metrics",
